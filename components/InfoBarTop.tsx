...
const InfoBarTop = () => {
  return (
    <div className="w-full bg-gradient-to-r fixed top-0 from-amber-700 to-black h-[50px] flex justify-between items-center max-sm:justify-end max-lg:pr-16 max-sm:pr-4 z-[999]">
