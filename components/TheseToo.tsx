      ...
      >
        ...
        >
          ...
          <div className="w-full flex items-center flex-col mt-8 ">
            ...
            <div className="absolute bottom-0 h-20 w-full flex justify-center items-center before:text-base font-semibold bg-black text-white rounded-b-2xl">
              Only $98,- p/d
            </div>
          </div>
        </div>
        ...
        >
          ...
          <div className="absolute bottom-0 h-20 w-full flex justify-center items-center text-base font-semibold bg-black text-white rounded-b-2xl">
            Only $85,- p/d
          </div>
        </div>
      </div>
